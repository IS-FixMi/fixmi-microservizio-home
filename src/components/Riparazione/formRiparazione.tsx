        ...
        <div className="max-w-4xl mx-auto rounded overflow-hidden shadow-lg">
          ...
          <div className="px-6 pt-4 pb-2">
            <form onSubmit={onSubmit}>
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="nomeRichiedente">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Inserisci il nome del titolare della richiesta"
                />
              </div>
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="cognomeRichiedente">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Inserisci il cognome del titolare della richiesta"
                />
              </div>
              <div className="mb-4">
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="numeroTelefono">
                ...
                <input
                  ...
                  name="numeroTelefono"
                  type="text"
                  placeholder="Inserisci il numero di telefono del titolare della richiesta"
                />
              </div>
              <div className="mb-4 justify-around flex">
                <button
                  ...
                  onClick={() => {
                    ...
                    document.getElementsByName("nomeRichiedente")[0].value = "";
                    document.getElementsByName("cognomeRichiedente")[0].value = "";
                    document.getElementsByName("emailRichiedente")[0].value = "";
                    document.getElementsByName("numeroTelefono")[0].value = "";
                  }}
                >
                  Cancella
                </button>
